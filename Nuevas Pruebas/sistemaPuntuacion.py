...
class Meteoritos(pygame.sprite.Sprite):
    def __init__(self):
        ...
        #si el valor aleatorio es 0, entonces:
        #Posibilidad ==1, o 2 o 3
        #Cuando se instancie un meteorito, del tamaño 100*100
        ...
        self.image.set_colorkey(NEGRO)
        self.rect = self.image.get_rect()
        #Posición inicial en x que van a tomar los meteoritos instanciados
        #Posicion aleatoria para todo el ancho de la pantalla menos el ancho del propio rectangulo
        #para evitar que se salga de la pantallla
        self.rect.x = random.randrange(ANCHO-self.rect.width)
...
"""def muestra_texto(pantalla,fuente, texto, color, dimensiones,x,y):
    #fuente, tamaño en pixeles de la fuente
    tip_letra = pygame.font.Font(fuente, dimensiones)
    #variable que muestre cualquier texto, su color y el string
    #True o false, es para que use el asliased o antialised, antialised es para un juego mas pixelado
    superficie = tip_letra.render(texto, True, color)
    #variable para obtener el rectangulo del texto
...
#estas instanciaciones se pueden eliminar porque inicialmente
#no vana  haber 
...
while ejecutando:
    ...
    #colision_disparo= pygame.sprite.groupcollide(meteoritos,balas, False, True)
